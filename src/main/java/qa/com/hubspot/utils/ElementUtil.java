...
public class ElementUtil {
	...
	public ArrayList<String> getDropDownOptionsValues(By locator) {
	...
	public void selectValuesFromDropDown(By locator, String value){
		java.util.List<WebElement> daysList = driver.findElements(locator);
	...
	public List visibilityOfAllElements(By locator, int timeOut){
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
